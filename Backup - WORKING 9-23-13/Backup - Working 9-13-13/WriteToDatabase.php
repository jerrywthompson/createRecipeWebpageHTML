	...
	foreach($data as $array)
		{
			...
			$action_taken = $array['ACTION_TAKEN'];
			$source = $array['SOURCE'];
			...
			$sql = ("INSERT INTO cam_events.events 
							(id, client, nav_sr_nbr, in_time, host_name, parameter, instance, value, icon, ack_date, ack_user, conf_date, doc_date, action_taken, source, annotation)
						VALUES('$alarmid', '$client', '$nav_sr_nbr', '$in_time', '$host_name', '$parameter', '$instance', '$value', '$icon', '$ack_date', '$ack_user', '$conf_date', '$doc_date', '$action_taken', '$source', '$annotation');");
