...
$recipe->name = "Bread Pudding";
$recipe->type = 'main_course';
$recipe->instructions = <<<HERE2 Preheat the oven to 180C/350F. Line a large baking tray with parchment paper and set aside.
...
Bake the rolls for 25 minutes, or until golden on the outside. Serve warm. 
HERE2;
$recipe->ingredients = "2 cups shredded cheese mozzarella or cheddar * See notes</br>
...
1 1/2 cups almond flour
3 large eggs Divided ** See notes";
$recipe->notes = "* Low moisture mozzarella cheese is best, as it has minimal flavor. 
...
";
$recipe->nutrition = "Serving: 1serving | Calories: 203kcal | Carbohydrates: 5g | Protein: 11g | Fat: 17g | Sodium: 222mg | Potassium: 46mg | Fiber: 2g | Vitamin A: 309IU | Calcium: 186mg | Iron: 1mg | NET CARBS: 3g";
